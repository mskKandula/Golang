...
func main() {
	...
	//run the command "go tool pprof -http=:8080 myprogram.prof" after the program finishes to visualize the profiling

	//uncomment the below statement for memory profiling
